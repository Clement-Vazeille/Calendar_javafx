...
public class Scene_manipulation {
    ...
    public static List<Text> setUpScene(Group root, Line line, int x_size,  int y_size, Text monthText,LocalDate date){
    ...
    public void unsetUoMonth(Group root,List<Text> textList){
        removeTextList(root,textList);
